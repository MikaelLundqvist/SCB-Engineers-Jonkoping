...
## Women's urbanization, comparison between the SSYK
Average basic salary, monthly salary and women´s salary as a percentage of men´s salary by region, sector, occupational group (SSYK 2012) and sex . Year 2014 - 2018
Number of employees
All sectors
```{r ssyk14-18_8, echo = TRUE, fig.cap = 'Womens urbanization, comparison between the SSYK, Year 2014 - 2018, positive x = tendency for women within SSYK to migrate to larger regions, negative x = tendency for women within SSYK to migrate to smaller regions'}	
