...
## Women with higher paid jobs migrate to regions with larger population, women with lower paid jobs migrate to regions with less population
Average basic salary, monthly salary and women´s salary as a percentage of men´s salary by sector, occupational group (SSYK 2012) , sex and age. Year 2014 - 2018
Monthly salary
All sectors
...
merge(summary_table, sumtab, by = "ssyk", all = TRUE) %>%
  ...
  cor.coef = TRUE, cor.method = "pearson") +
  labs(
    x = "estimate fow women urbanization",
...
merge(summary_table, sumtab, by = "ssyk", all = TRUE) %>% 
  ...
  knitr::kable( 
  booktabs = TRUE,
  caption = 'Women with higher paid jobs migrate to regions with larger population, women with lower paid jobs migrate to regions with less population')   
```
