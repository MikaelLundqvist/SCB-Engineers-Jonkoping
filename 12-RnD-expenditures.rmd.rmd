...
## F-value for Regional distribution of enterprises R&D compared to the level of Regional distribution of enterprises R&D

```{r rndexpenditures8, echo = TRUE, fig.cap = 'F-value for Regional distribution of enterprises R&D compared to the level of Regional distribution of enterprises R&D'} 
...
merge(summary_table, anova_table, by = "ssyk", all = TRUE) %>% 
  ...
  knitr::kable( 
  booktabs = TRUE,
  caption = 'Correlation F-value for Regional distribution of enterprises R&D compared to the level of Regional distribution of enterprises R&D') 
```
